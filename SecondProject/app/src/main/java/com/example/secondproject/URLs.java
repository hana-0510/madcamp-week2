...
public class URLs {
    ...
    private static final String ROOT_URL = "http://192.249.19.243:0780/";
    ...
    public static final String URL_EDI_CONTACT= ROOT_URL + "edit_contact";
    ...
    public static final String URL_EDI_TODO_DATE= ROOT_URL + "edit_todo_date";
    public static final String URL_EDI_TODO_DO= ROOT_URL + "edit_todo_do";



    public static final String URL_ADD_IMAGE= ROOT_URL + "add_Image";
    public static final String URL_GET_IMAGE= ROOT_URL + "get_image";
    public static final String URL_DEL_IMAGE= ROOT_URL + "del_image";
